...
How to Use
1. Prerequisites
Ensure you have Python installed along with the necessary libraries. The main dependencies usually include:
...
To create and simulate a custom network, edit or run:

Bash

python power_grid_simulation.py
4. Calculating Errors
To compare results and generate an error report:

Ensure the input files (that you wish to compare) are correctly configured inside the erro.py script.
...
Como Usar
1. Pré-requisitos
Certifique-se de ter o Python instalado e as bibliotecas necessárias. As principais dependências geralmente incluem:
...
Para criar e simular uma rede personalizada, edite ou execute:
