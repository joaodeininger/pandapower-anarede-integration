...
print("Carregando sistema IEEE 30 nativo...")

# Carrega o sistema IEEE 30 padrão (que é exatamente o que está no seu txt)
net = pn.case_ieee30()
...
net.res_bus[["vm_pu", "va_degree"]].to_csv("resultados_ieee30.csv", index=False)
